...
点聚合组件，需要在 [Map](./map) 里面使用，并且需要 <a href="https://lbs.amap.com/api/javascript-api/reference/plugin/#AMap.MarkerClusterer" target="_blank" rel="noreferrer">AMap.MarkerClusterer</a> 插件。
...
若写的不详细<a href="https://lbs.amap.com/api/javascript-api/reference/plugin/#AMap.MarkerClusterer" target="_blank" rel="noreferrer">参考</a>。
